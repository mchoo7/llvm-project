...
#ifndef LLDB_SOURCE_TARGET_REGISTERCONTEXTTHREADMEMORY_H
#define LLDB_SOURCE_TARGET_REGISTERCONTEXTTHREADMEMORY_H
...
#endif // LLDB_SOURCE_TARGET_REGISTERCONTEXTTHREADMEMORY_H
