...
#ifndef LLDB_SOURCE_PLUGINS_PROCESS_GDB_REMOTE_INFERIORCALLPOSIX_H
#define LLDB_SOURCE_PLUGINS_PROCESS_GDB_REMOTE_INFERIORCALLPOSIX_H
...
#endif // LLDB_SOURCE_PLUGINS_PROCESS_GDB_REMOTE_INFERIORCALLPOSIX_H
